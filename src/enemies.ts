...
export const createEnemy = (resources: PIXI.IResourceDictionary, speed: number): Enemy => {
...
const moveLeft = (enemy: Enemy) => (enemy.sprite.x -= enemy.speed)
const moveRight = (enemy: Enemy) => (enemy.sprite.x += enemy.speed)
const moveUp = (enemy: Enemy) => (enemy.sprite.y -= enemy.speed)
const moveDown = (enemy: Enemy) => (enemy.sprite.y += enemy.speed)
